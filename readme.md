...
1. githubから拡張のソースコードをダウンロードします。プロジェクトページ( https://github.com/Inarinokami/exkakuyomu )の右上にある緑色のボタン"Clone or download"を押して"Download ZIP"を選択するのが最も簡単です。
...
4. 1で表示されるようになった、『パッケージ化されていない拡張機能を読み込む』というボタンをクリックします。
